    ...
    class O {
        ...
        validateFieldRule(e, t, s, i = !1) {
            ...
            switch (s.rule) {
                ...
                case d.MinFilesCount: {
                    ...
                    if (
                        Number.isFinite(a == null ? void 0 : a.length) &&
                        a.length < r
                    ) {
                        this.setFieldInvalid(e, s);
                        break;
                ...
                case d.Files: {
                    ...
                    const o = (c, h) => {
                        const f =
                                Number.isFinite(h.minSize) &&
                                c.size < h.minSize,
                            m =
                                Number.isFinite(h.maxSize) &&
                                c.size > h.maxSize,
                            v =
                                Array.isArray(h.names) &&
                                !h.names.includes(c.name),
                            D =
        ...
        renderTooltip(e, t, s) {
            ...
            const {
                ...
                c =
                    s ||
                    ((f = this.globalConfig.tooltip) == null
                        ? void 0
                        : f.position);
            switch (c) {
                case 'left': {
        ...
        renderFieldLabel(e, t) {
            ...
            if (e.type === 'checkbox' || e.type === 'radio') {
                ...
                ((i = (s = e.parentElement) == null ? void 0 : s.tagName) ==
                null
                    ? void 0
                    : i.toLowerCase()) === 'label'
                    ? (a =
                          (r = e.parentElement) == null
                              ? void 0
                              : r.parentElement) == null || a.appendChild(t)
                    : h
